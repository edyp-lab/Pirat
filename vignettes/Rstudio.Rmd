...
2. `adj`, the adjacency matrix between peptides and proteins, containing etiher booleans or 0s and 1s (not preprocessing or simplification is needed for this matrix, Pirat will automatically build the PGs from it).
