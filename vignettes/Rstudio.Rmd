...
```
The first plot represents the goodness of fit of the inverse-gamma distribution, whereas the second one
represents the goodness of fit of the missingness mechanism (details on method used is given in @Etourneau2023). Note that only few peptides have been used to fit these distributions in both cases, as we use a subset from the original Bouyssie2020 dataset.
